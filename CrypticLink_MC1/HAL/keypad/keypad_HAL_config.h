...
#define KEYPAD_ROW1_PORT	DIO_u8PortC

#define KEYPAD_ROW2_PIN		DIO_u8PIN1
#define KEYPAD_ROW2_PORT	DIO_u8PortC

#define KEYPAD_ROW3_PIN		DIO_u8PIN2
#define KEYPAD_ROW3_PORT	DIO_u8PortC

#define KEYPAD_ROW4_PIN		DIO_u8PIN3
#define KEYPAD_ROW4_PORT	DIO_u8PortC
/********************************************************/

/********************** Keypad col **********************/
#define KEYPAD_COL1_PIN		DIO_u8PIN4
#define KEYPAD_COL1_PORT	DIO_u8PortC

#define KEYPAD_COL2_PIN		DIO_u8PIN5
#define KEYPAD_COL2_PORT	DIO_u8PortC

#define KEYPAD_COL3_PIN		DIO_u8PIN6
#define KEYPAD_COL3_PORT	DIO_u8PortC

#define KEYPAD_COL4_PIN		DIO_u8PIN7
#define KEYPAD_COL4_PORT	DIO_u8PortC
/********************************************************/
